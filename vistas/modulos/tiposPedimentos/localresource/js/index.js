...
function Crear(tipo){
    ...
    document.getElementById('tipoPedimento').value = '';
...
function Editar(nodo,tipo){
    ...
    if (tipo==1){
       ...
       document.getElementById('tipoPedimento').enabled = true;
    }
...
function quitarSimbolos(){
    ...
    var EtipoPedimento = document.getElementById('tipoPedimento').value;

   // alert(Ecategoria);
    var specialChars = "!@$^&%*()+=-[]\/{}|:<>?,;.'";

    for (var i = 0; i < specialChars.length; i++) {
        EtipoPedimento = EtipoPedimento.replace(new RegExp("\\" + specialChars[i], "gi"), "");
       
    }

    document.getElementById('tipoPedimento').value = EtipoPedimento;

    validarTamaño(EtipoPedimento);
}
    ...
    ajaxGeneral(function(res){
        ...
        if(res[0].error == 'true'){
         ...
         var alertx = document.getElementById("divAlerta");
            ...
            var notificator = new Notification(document.querySelector('.notification'));
            notificator.info('Tipo pdimento insertdo');
...
var alertx = document.getElementById("divAlerta");
  // alertx.innerHTML = "El campo de producto es obligatorio";
   alertx.style.display="block";
   var div = document.getElementById('txt_alert');
   div.innerHTML += 'El campo de tipo de pedimento es obligatorio';
}
}
...
function Modificar(){
    ...
    ajaxGeneral(function(res){
        ...
        if(res[0].error == 'true'){
            ...
            var notificator = new Notification(document.querySelector('.notification'));
            notificator.info('Tipo de pedimento Actualizado');
            Cancelar();
        }
...
function Eliminar(e){
    ...
    ajaxGeneral(function(res){
        ...
        if(res[0].error == 'true'){
            ...
            notificator.info('Tipo de pedimento eliminado');

            document.getElementById('tipoPedimento').disabled = false;

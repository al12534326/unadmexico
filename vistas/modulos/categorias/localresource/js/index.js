...
function ObtenerCategorias (valPaginacion)
{
       ...
       if (valBucle > 1) 
        {
            ...
            for (var i=1; i<=valBucle; i++) 
            {
                if (i == paginaActiva)
                {
                    paginacion = paginacion + '<li><a onclick="ObtenerCategorias('+i+')" class="active" >'+ i +'</a></li>';
                }
                else
                {
                    paginacion = paginacion + '<li><a onclick="ObtenerCategorias('+i+')" >'+ i +'</a></li>';
                }
            }
        ...
        // fin funcionalidad    
    }, "http://localhost:8066/controladores/categorias.php?funcion=listar_categorias&parametros=5," + paginaActiva);
...
function GuardarUsuario(){
    ...
    ajaxGeneral(function(res){
        ...
        CancelarUsuario();
    }, "http://localhost:8066/controladores/categorias.php?funcion=guardar_categoria&parametros="+a)
...
function ModificarUsuario(){
    ...
    ajaxGeneral(function(res){
        ...
        CancelarUsuario();
    }, "http://localhost:8066/controladores/categorias.php?funcion=modificar_categoria&parametros="+a+','+b)
...
function EliminarUsuario(){
    ...
    ajaxGeneral(function(res){
        ...
        CancelarEmpresa();
    }, "http://localhost:8066/controladores/categorias.php?funcion=eliminar_categoria&parametros="+a)
